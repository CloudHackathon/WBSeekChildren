...
- (void)netWorking{
    [[AFHTTPSessionManager manager] POST:@"http://123.207.234.128:8080/upload"
               ...
               constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData)
     {
         ...
         UIImage *_originImage = [self normalizedImage:self.image];
         NSData *_data = UIImageJPEGRepresentation(_originImage,0.5);
...
//         [formData appendPartWithFormData:UIImageJPEGRepresentation(self.image, 1.0) name:@"image"];
